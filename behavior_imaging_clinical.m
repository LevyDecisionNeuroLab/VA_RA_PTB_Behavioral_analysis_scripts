...
% load PCA loadings
loadingsfilename = fullfile(root_behav,'pca loadings.xlsx');
...
%% create table for multilinear model
...
tb2plot1 = table(tb2ml.CP1, tb2ml.CP2, tb2ml.CP3,...
    'VariableNames',{'CP1','CP2','CP3'});
