...
tb2plot = table(tb.caps_total_pm(include), tb.bdiii_total(include),tb.madrs_total(include),...
...
tb2plot = table(tb.caps_total_pm(include), tb.bdiii_total(include),...
...
%% PCA all clinical 
tb2pca = table(tb.bdiii_total(include),tb.madrs_total(include),...
    tb.hama_total(include), tb.stai_x1_total(include), tb.stai_x2_total(include),...
    tb.bai_total(include), tb.rses_total(include),...
